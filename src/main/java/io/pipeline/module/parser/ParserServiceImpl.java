...
import io.pipeline.module.parser.tika.TikaMetadataExtractor;
                                ...
                                try {
                                    ...
                                    try {
                                        if (tikaResponse.hasEpub() && tikaResponse.getEpub().getTableOfContentsCount() > 0) {
                                            io.pipeline.data.v1.DocOutline outline = io.pipeline.module.parser.tika.builders.EpubStructureExtractor
                                                    .buildDocOutlineFromToc(tikaResponse.getEpub().getTableOfContentsList());
                                            io.pipeline.data.v1.SearchMetadata sm = parsedDoc.getSearchMetadata().toBuilder()
                                    ...
                                    try {
                                        if (tikaResponse.hasPdf() && (filename != null && filename.toLowerCase().endsWith(".pdf"))) {
                                            ...
                                            io.pipeline.data.v1.DocOutline outline = io.pipeline.module.parser.tika.builders.PdfOutlineExtractor
                                    ...
                                    try {
                                        ...
                                        if (mdEnabled && filename != null && filename.toLowerCase().endsWith(".md")) {
                                            ...
                                            io.pipeline.data.v1.DocOutline outline = io.pipeline.module.parser.tika.builders.MarkdownExtractor
                                                    .buildDocOutlineFromMarkdown(bytes, 1, 6, true);
                                            java.util.List<io.pipeline.data.v1.LinkReference> links = io.pipeline.module.parser.tika.builders.MarkdownExtractor
                                            ...
                                            try {
                                                ...
                                                if (base != null && base.getHost() != null) {
                                                    ...
                                                    java.util.List<io.pipeline.data.v1.LinkReference> adjusted = new java.util.ArrayList<>(links.size());
                                                    for (io.pipeline.data.v1.LinkReference lr : links) {
                                            ...
                                            io.pipeline.data.v1.SearchMetadata.Builder smb = outputDocBuilder.hasSearchMetadata()
                                    ...
                                    try {
                                        if (tikaResponse.hasHtml()) {
                                            ...
                                            if (htmlBytes != null && htmlBytes.length > 0) {
                                                io.pipeline.module.parser.config.OutlineExtractionOptions ox = config.outlineExtraction();
                                                boolean enabled = (ox == null) || Boolean.TRUE.equals(ox.enableHtmlOutline());
                                                if (enabled) {
                                                    io.pipeline.data.v1.DocOutline outline = io.pipeline.module.parser.tika.builders.HtmlOutlineExtractor
                                                ...
                                                try {
                                                    java.util.List<io.pipeline.data.v1.LinkReference> links = io.pipeline.module.parser.tika.builders.HtmlOutlineExtractor
                                                            .extractLinks(
                                                                    htmlBytes,
