...
public final class HtmlOutlineExtractor {
    ...
    public static java.util.List<io.pipeline.data.v1.LinkReference> extractLinks(
            byte[] htmlBytes,
            String baseUri,
            boolean stripScripts,
            String includeCss,
        ...
        java.util.List<io.pipeline.data.v1.LinkReference> out = new java.util.ArrayList<>();
        ...
        for (Element a : working.select("a[href]")) {
            ...
            io.pipeline.data.v1.LinkReference.Builder lb = io.pipeline.data.v1.LinkReference.newBuilder()
