...
import ai.pipestream.parsed.data.epub.v1.EpubManifestItem;
import ai.pipestream.parsed.data.epub.v1.EpubContentItem;
import ai.pipestream.parsed.data.epub.v1.EpubEmbeddedResource;
import ai.pipestream.parsed.data.epub.v1.EpubTocItem;
