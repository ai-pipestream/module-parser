package io.pipeline.module.parser.tika;

import io.pipeline.module.parser.tika.builders.DocumentTypeDetector;
import io.pipeline.module.parser.tika.builders.MetadataUtils;
import io.pipeline.module.parser.tika.builders.PdfMetadataBuilder;
import io.pipeline.module.parser.tika.builders.OfficeMetadataBuilder;
import io.pipeline.module.parser.tika.builders.RtfMetadataBuilder;
import io.pipeline.module.parser.tika.builders.EpubMetadataBuilder;
import io.pipeline.module.parser.tika.builders.ImageMetadataBuilder;
import io.pipeline.module.parser.tika.builders.EmailMetadataBuilder;
import io.pipeline.module.parser.tika.builders.MediaMetadataBuilder;
import io.pipeline.module.parser.tika.builders.HtmlMetadataBuilder;
import io.pipeline.module.parser.tika.builders.WarcMetadataBuilder;
import io.pipeline.module.parser.tika.builders.CreativeCommonsMetadataBuilder;
import io.pipeline.module.parser.tika.builders.FontMetadataBuilder;
import io.pipeline.parsed.data.dublin.v1.DublinCoreMetadata;
import io.pipeline.parsed.data.tika.v1.TikaResponse;
import io.pipeline.parsed.data.tika.v1.TikaContent;
...
public class TikaMetadataExtractor {
    ...
    public static TikaResponse extractComprehensiveMetadata(
        ...
        switch (docType) {
            ...
            case DATABASE:
                responseBuilder.setDatabase(io.pipeline.module.parser.tika.builders.DatabaseMetadataBuilder
            ...
            case CLIMATE_FORECAST:
                responseBuilder.setClimateForecast(io.pipeline.module.parser.tika.builders.ClimateForecastMetadataBuilder
                        .build(tikaMetadata, parserClass, tikaVersion));
                break;
     ...
     */
    private static io.pipeline.parsed.data.generic.v1.GenericMetadata buildGenericMetadata(
            Metadata tikaMetadata, String parserClass, String tikaVersion) {
        
        io.pipeline.parsed.data.generic.v1.GenericMetadata.Builder builder = 
                io.pipeline.parsed.data.generic.v1.GenericMetadata.newBuilder();
        ...
        // Build base fields
        io.pipeline.parsed.data.tika.base.v1.TikaBaseFields baseFields = 
